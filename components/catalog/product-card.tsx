...
export function ProductCard({ product, priority = false }: { product: Product; priority?: boolean }) {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-md border border-line bg-white transition duration-300 hover:-translate-y-1 hover:border-[#d7c5a7] hover:shadow-[0_22px_58px_rgba(11,13,15,0.10)]">
