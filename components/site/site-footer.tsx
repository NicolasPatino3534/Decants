      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)] lg:px-8">
        ...
        <div className="grid min-w-0 gap-6 text-sm text-muted sm:grid-cols-[repeat(3,minmax(0,1fr))]">
          <div className="min-w-0">
            ...
            <Link className="mt-3 block hover:text-amber" href="/catalogo">Catálogo</Link>
            <Link className="mt-2 block hover:text-amber" href="/#discovery-sets">Discovery sets</Link>
            <Link className="mt-2 block hover:text-amber" href="/#marcas">Marcas</Link>
          </div>
          <div className="min-w-0">
            <p className="font-semibold text-ink">Confianza</p>
            <Link className="mt-3 block hover:text-amber" href="/#confianza">Compra segura</Link>
          ...
          <div className="min-w-0">
            ...
            <a className="mt-3 block hover:text-amber" href={whatsappUrl("Hola DecantsCBA, quiero hacer una consulta.")}>WhatsApp {brand.whatsapp}</a>
            <a className="mt-2 block break-all hover:text-amber" href={`mailto:${brand.email}`}>{brand.email}</a>
            <p className="mt-2">{brand.location}</p>
            <a className="mt-2 block hover:text-amber" href={brand.instagramUrl}>{brand.instagram}</a>
          </div>
        </div>
      </div>
