  ...
  return (
    <div>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[#665d50]">
            Lista simple para entrar al detalle de cada perfume y editar datos,
            imágenes, stock, estado y variantes.
          </p>
        </div>
      ...
      <section className="mt-6 overflow-hidden rounded-md border border-line bg-white">
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <p className="break-words font-black text-ink">
                      {product.name}
                    </p>
                ...
                <dl className="mt-4 grid grid-cols-3 gap-3 text-sm">
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-[0.14em] text-[#8a806f]">
                      Categoría
                    </dt>
                    <dd className="mt-1 text-[#665d50]">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 font-black text-ink">
                      {minPrice ? formatMoney(minPrice) : "Sin variantes"}
                    </dd>
                  </div>
                </dl>
                <Link
        ...
        {products.length === 0 ? (
          <p className="p-6 text-sm text-[#665d50]">
