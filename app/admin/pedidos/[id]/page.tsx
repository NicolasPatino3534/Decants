...
export default async function AdminOrderDetailPage({
  ...
  return (
    <div>
      <Link
        href="/admin/pedidos"
        className="inline-flex items-center gap-2 text-sm font-bold text-[#7a5a20] hover:text-ink"
      >
        <ArrowLeft size={16} />
        Volver a pedidos
      </Link>
        ...
        <div className="flex flex-col gap-4 border-b border-line pb-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                {orderStatusLabel(order.shipmentStatus)}
              </StatusBadge>
            </div>
